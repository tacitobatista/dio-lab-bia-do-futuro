...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderi validar as respostas do Edu de forma mais assertiva.
...
```python
  ...
  with open('data/produtos_financeiros.json', 'r', encoding=utf-u) as f:
...
Para simplificar, podemos simplesmente "injetar" os dados em nosso prompt, garantindo que o Agente tenha o melhor contexto possível. Lembrando que em soluções mais robustas o idela é que essas informações sejam carregadas dinamicamente para que possamos ganhar flexibilidade.
